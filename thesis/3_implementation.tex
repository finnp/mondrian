...
represented as three-dimensional NumPy arrays. The first two dimensions of this array encode the positions of pixels in the image, while the third dimension
