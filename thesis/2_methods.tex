...
% TODO: Definitions, e.g. Binary Image and Mondrian painting
...
\textit{Structuring Element} with an anchor point $a \element B$,
...
work well for all images, we instead used \textit{Contrast Limited Adaptive Histogram
...
pixel of the input image. The resulting mask from this calculation is added to
...
create a mask that applies a Dilation $A_m = A_2 \oplus B_d$ with a larger
...
leaving inner areas of black rectangles. The resulting mask $A_m$ is then
