...
% TODO: Better exaplain Global harmonization -> Adaptive harmonization -> CLAHE
...
Now the image is converted into a binary image using an arbitrary threshold for the
